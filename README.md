...
[github repository settings]: https://github.com/kb-tan/crm-integration/settings

## Design

crm-integration is a Node.js HTTP server built in line with our [technology strategy].
